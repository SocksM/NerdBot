...
public class GeneratorCommands extends ApplicationCommand {
    ...
    @JDASlashCommand(name = BASE_COMMAND, group = GROUP_POWERSTONE, subcommand = "powerstone", description = "Generate an image of a Power")
    ...
    public void generatePowerstone(
        ...
        @AppOption(description = MAGICAL_POWER_DESCRIPTION) Integer magicalPower,
        ...
        try {
            ...
            for (Map.Entry<String, Integer> entry : scalingStatsMap.entrySet()) {
                ...
                scalingStatsFormatted.append(String.format("%%%%%s:%s%%%%\\n", statName, Util.COMMA_SEPARATED_FORMAT.format(ScalingPowerstoneStat.calculateScalingPowerStoneStat(stat, magicalPower, basePower))));
            }
