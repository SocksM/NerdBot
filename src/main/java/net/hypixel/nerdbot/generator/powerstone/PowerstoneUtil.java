...
public class PowerstoneUtil {
    ...
    public static final String SCALING_STATS_HEADER_POWERSTONE_FORMAT = "&rAt &6%d Magical Power&7:"; // %d = Magical power amount
    ...
    public static String parseScalingStatsToString(List<ScalingPowerstoneStat> stats) {
        ...
        stats.forEach(stat -> output.append(stat).append("\\n"));
